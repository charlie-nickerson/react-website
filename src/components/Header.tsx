...
function Header(){
    return(
        <div className="Desktop1" style={{width: '100%', height: '100%', position: 'fixed', background: '#001011'}}>
            <div className="Ellipse1" style={{width: 2036, height: 1737, background: 'radial-gradient(100.00% 100.00% at -Infinity% NaN%, #093A3E 0%, rgba(9, 58, 62, 0) 100%)'}}></div>
            ...
            <div className="Frame1" style={{width: 246, height: 69, padding: 10, left: 327, top: 721, position: 'fixed', background: 'rgba(255, 255, 255, 0.30)', borderRadius: 30, border: '1px white solid', justifyContent: 'center', alignItems: 'center', gap: 10, display: 'inline-flex'}}>
